...
public class PageController {
    ...
    public String mitigationCostRoot(Model model) {
        ...
        List<County> costCounties = costEvidenceHubService.costIndexableCounties(dataLoadService.getCountyBySlugMap().values().stream()
                ...
                .toList());
        Map<String, List<County>> stateMap = costEvidenceHubService.stateMap(costCounties);
        model.addAttribute("stateMap", stateMap);
        model.addAttribute("costEvidenceInsight", costEvidenceHubService.buildInsight(stateMap, costCounties));
    ...
    public Object stateHub(@PathVariable("stateSlug") String stateSlug, Model model) {
        ...
        List<County> visibleCounties = costEvidenceHubService.costIndexableCounties(stateCounties);
        ...
        model.addAttribute("costEvidenceInsight", costEvidenceHubService.buildInsight(
